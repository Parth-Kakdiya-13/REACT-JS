...
export const Dialog = ({ text, onClick, logo }) => {
    return (
        <>
            <div className=' fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50' onClick={onClick}>
                <div className='w-full relative bg-white rounded-2xl p-5 flex flex-col items-center  z-50'>
