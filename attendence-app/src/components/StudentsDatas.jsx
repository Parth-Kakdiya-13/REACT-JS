...
export const StudentsDatas = (props) => {
    ...
    return (
        <div className='border-2 border-gray-300 rounded-xl p-5 my-2 max-sm:p-2'>
            ...
            <button className='gf1 bg-gray-500 px-5 py-1 rounded-lg text-white ml-auto mt-2' onClick={() => { sendDataHandler({ ...props }) }}>Read more</button>
        </div>
    )
}
